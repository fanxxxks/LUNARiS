...
function moduleParts(type){
 ...
 const identity=palette[type],accent=new T.MeshStandardMaterial({color:identity.color,map:mats.hull.map||null,roughnessMap:mats.hull.roughnessMap||null,normalMap:mats.hull.normalMap||null,normalScale:new T.Vector2(.025,.025),metalness:.16,roughness:.72,envMapIntensity:.8});
