...
let yaw=.64,pitch=.25,distance=1230,target=new T.Vector3(-30,212,0),goal={yaw:.64,pitch:.25,distance:1230,target:new T.Vector3(-30,212,0)};
...
function chooseView(name){
 ...
 else goal={yaw:.64,pitch:cutaway?.3:.25,distance:overviewDistance(),target:new T.Vector3(-30,212,0)};
 }
 updateViewButtons();
}
